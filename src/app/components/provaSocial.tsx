        ...
        <section className="section pricing" id="pricing">
            <div className="container">
                ...
                <h3 className="section-subtitle padd-15">Saiba como os Trailblazers alcançam o sucesso com o ecossistema completo de apps,
                    parceiros e especialistas de mercado do Customer 360.</h3>
                <div className="row">
                    {/* prices */}
                    <div className="prices">
                        <div className="price-item">
                            ...
                            <p>"Os produtos da Salesforce nos ajudaram
                                ...
                                Diretora de Marketing e Digital, L’Oreal</p>
                        </div>
                    </div>
                    {/* prices */}
                    <div className="prices">
                        <div className="price-item best">
                            <img src="https://i.ibb.co/NLhMPbd/rbc.png" alt="Equipe RBC Wealth Management" />
                            <h3 className="plan">RBC Wealth Management</h3>
                            <p>"Na preparação para reuniões com clientes, os
                                consultores precisavam checar até 26 sistemas
                                diferentes. Isso consumia de 3 a 4 horas de
                                preparativos só para uma reunião. Agora, todas
                    ...
                    <div className="prices">
                        <div className="price-item">
                            ...
                            <p>"Com o Salesforce, nossos representantes de
                                vendas batem cotas que são 4 a 10x maiores
                                que as de outras empresas." — Demetrios Barns,
                                Cofundador e COO, SmartRent</p>
                        </div>
                    </div>
                </div>
            </div>
